...
typedef void (*MOUSE_HANDLER   )(HWND hWnd, WPARAM uID);
typedef BOOL (*CX_MENU_CALLBACK)(HWND hWND, WPARAM uID, HMENU& hMenu, UINT& uFlags, int& nSubMenu);
...
class NI_API CNotifyIcon
{
  public:
	...
	BOOL CNotifyIcon::Modify(LPCTSTR szTip);
    BOOL Remove();
    BOOL Restore();
